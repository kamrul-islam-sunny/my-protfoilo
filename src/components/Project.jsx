            ...
            <section id='project' className="py-8 bg-white text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {allProjects.map((project, index) => (
                        <div
                            key={index}
                            className="bg-white border border-gray-200 hover:border-gray-400 p-4 rounded-md shadow-lg hover:shadow-xl duration-300 transition-all transform hover:scale-105 hover:translate-y-2"
                        >
                            {/* Project Image */}
                            <img
                            ...
                            <div className="flex items-center justify-end gap-2">
                                <Link to={`/${project.slug}`} className="text-gray-600 hover:underline flex items-center">
                                    <IoBookOutline className="mr-2" />
                                </Link>
                                <a target='_blank' href={project.github_repository_link} className="text-gray-600 hover:underline flex items-center">
                                    <VscSourceControl className="mr-2" />
                                </a>
                                <a target='_blank' href={project.live_project_link} className="text-gray-600 hover:underline flex items-center">
